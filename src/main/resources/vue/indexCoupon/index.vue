    ...
    <div v-loading="loading">
        ...
        <div class="searchBox">
            <el-row v-model="queryParms" :gutter="20" class="operation">
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">代金券编号： </span>
                    <el-input class="SearchInput" v-model="queryParms.couponId" placeholder="请输入代金券编号"></el-input>
                </el-col>
                <el-col :span="8">
        ...
        <div class="resultBox">
            ...
            <el-table :data="list" border style="width: 100%">
                <el-table-column prop="couponId" label="代金券编号" align="center"></el-table-column>
