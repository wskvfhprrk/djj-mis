    ...
    <div v-loading="loading">
        ...
        <div class="searchBox">
            <el-row v-model="queryParms" :gutter="20" class="operation">
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">编号（每张代金券唯一编号）： </span>
                    <el-input class="SearchInput" v-model="queryParms.couponNo" placeholder="请输入编号（每张代金券唯一编号）"></el-input>
                </el-col>
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">发出方（id+名称）： </span>
                    <el-input class="SearchInput" v-model="queryParms.fromName" placeholder="请输入发出方（id+名称）"></el-input>
                </el-col>
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">接收方（id+名称）： </span>
                    <el-input class="SearchInput" v-model="queryParms.toName" placeholder="请输入接收方（id+名称）"></el-input>
                </el-col>
                <el-col class="marginBottom" :span="8">
                ...
                <el-col :span="8">
                    <el-button size="medium" type="primary" v-allow="couponHistory_get" @click="search">查询</el-button>
                </el-col>
            </el-row>
        </div>
        <!-- 操作 end-->
        ...
        <div class="resultBox">
            <el-row :gutter="20">
                ...
                <el-button class="addBtn" v-allow="couponHistory_post" @click="add" size="medium" type="primary">新增
                </el-button>
            </el-row>
            <el-table :data="list" border style="width: 100%">
                <el-table-column prop="couponNo" label="编号（每张代金券唯一编号）" align="center"></el-table-column>
                <el-table-column prop="fromName" label="发出方（id+名称）" align="center"></el-table-column>
                <el-table-column prop="toName" label="接收方（id+名称）" align="center"></el-table-column>
                <el-table-column prop="createTime" label="创建时间" align="center"></el-table-column>
                <el-table-column prop="remark" label="备注" align="center"></el-table-column>
                <el-table-column label="操作" width="200" align="center">
                    <template slot-scope="scope">
                        <el-button v-allow="couponHistory_put" size="mini" type="info" @click="edit(scope.$index,scope.row)">
                            编辑</el-button>
                        <el-button size="mini" type="danger" v-allow="couponHistory_*_delete" @click="deleteHandel(scope.$index,scope.row)">
                            删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    import * as couponHistory from '../../api/couponHistory.js';
    ...
    export default {
        ...
        methods: {
            ...
            fetchData(param) {//查询
                ...
                couponHistory.list.r(str).then((res) => {
            ...
            getViewInfo(data) {
                ...
                couponHistory.view.r(data.id).then(res => {
                    if (res.data.success) {
            ...
            submitHandle() {//新增提交
                ...
                vm.loading = true
                couponHistory.add.r(vm.$refs.formPage.form).then(res => {
                    if (res.data.success) {
            ...
            editsubmit() {//新增提交
                ...
                vm.loading = true
                couponHistory.edit.r(vm.$refs.formPage.form).then(res => {
                    if (res.data.success) {
            ...
            clock(item, data) {
                ...
                var param = data.id;
                couponHistory.clock.r(param).then(res => {
                    if (res.data.success) {
            ...
            click(item, data) {
                ...
                var param = data.id;
                couponHistory.click.r(param).then(res => {
                    if (res.data.success) {
                        vm.$message.success('切换');
                        vm.loading = false;
                        vm.search();
            ...
            deleteHandel(item, data) {
                ...
                var param = data.id;
                couponHistory.remove.r(param).then(res => {
                    if (res.data.success) {
