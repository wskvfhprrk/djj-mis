    ...
    <div v-loading="loading">
        ...
        <div class="searchBox">
            <el-row v-model="queryParms" :gutter="20" class="operation">
                ...
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">性别（0:男，1:女）： </span>
                    <el-input class="SearchInput" v-model="queryParms.sex" placeholder="请输入性别（0:男，1:女）"></el-input>
                </el-col>
                <el-col class="marginBottom" :span="8">
                ...
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">角色（0-老板 1-店长 2-员工）： </span>
                ...
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">状态（0-正常 1-暂停 2-注销）： </span>
                    <el-input class="SearchInput" v-model="queryParms.status" placeholder="请输入状态（0-正常 1-暂停 2-注销）"></el-input>
                </el-col>
                <el-col class="marginBottom" :span="8">
        ...
        <div class="resultBox">
            ...
            <el-table :data="list" border style="width: 100%">
                ...
                <el-table-column prop="sex" label="性别（0:男，1:女）" align="center"></el-table-column>
                <el-table-column prop="birthday" label="生日" align="center"></el-table-column>
                <el-table-column prop="phone" label="联系方式" align="center"></el-table-column>
                <el-table-column prop="role" label="角色（0-老板 1-店长 2-员工）" align="center"></el-table-column>
                <el-table-column prop="shopId" label="店铺编号" align="center"></el-table-column>
                <el-table-column prop="createTime" label="创建时间" align="center"></el-table-column>
                <el-table-column prop="updateTime" label="更新时间" align="center"></el-table-column>
                <el-table-column prop="status" label="状态（0-正常 1-暂停 2-注销）" align="center"></el-table-column>
                <el-table-column prop="openId" label="用户在微信端的唯一标识" align="center"></el-table-column>
                <el-table-column label="操作" width="200" align="center">
                    <template slot-scope="scope">
                        <el-button v-allow="shopUser_put" size="mini" type="info" @click="edit(scope.$index,scope.row)">
                            编辑</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            getViewInfo(data) {
                ...
                shopUser.view.r(data.userId).then(res => {
                    if (res.data.success) {
            ...
            editsubmit() {//新增提交
                ...
                vm.loading = true
                shopUser.edit.r(vm.$refs.formPage.form).then(res => {
                    if (res.data.success) {
