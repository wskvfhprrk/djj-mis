    ...
    <div v-loading="loading">
        ...
        <div class="searchBox">
            <el-row v-model="queryParms" :gutter="20" class="operation">
                ...
                <el-col :span="8">
                    <el-button size="medium" type="primary" v-allow="businessDistrict_get" @click="search">查询</el-button>
                </el-col>
            </el-row>
        </div>
        <!-- 操作 end-->
        ...
        <div class="resultBox">
            <el-row :gutter="20">
                ...
                <el-button class="addBtn" v-allow="businessDistrict_post" @click="add" size="medium" type="primary">新增
                </el-button>
            </el-row>
            <el-table :data="list" border style="width: 100%">
                ...
                <el-table-column label="操作" width="200" align="center">
                    <template slot-scope="scope">
                        <el-button v-allow="businessDistrict_put" size="mini" type="info" @click="edit(scope.$index,scope.row)">
                            编辑</el-button>
                        <el-button size="mini" type="danger" v-allow="businessDistrict_*_delete" @click="deleteHandel(scope.$index,scope.row)">
                            删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            fetchData(param) {//查询
                ...
                businessDistrict.list.r(str).then((res) => {
            ...
            getViewInfo(data) {
                ...
                businessDistrict.view.r(data.businessDistrictId).then(res => {
                    if (res.data.success) {
            ...
            submitHandle() {//新增提交
                ...
                vm.loading = true
                businessDistrict.add.r(vm.$refs.formPage.form).then(res => {
                    if (res.data.success) {
            ...
            editsubmit() {//新增提交
                ...
                vm.loading = true
                businessDistrict.edit.r(vm.$refs.formPage.form).then(res => {
                    if (res.data.success) {
            ...
            clock(item, data) {
                ...
                var param = data.businessDistrictId;
                businessDistrict.clock.r(param).then(res => {
                    if (res.data.success) {
            ...
            click(item, data) {
                ...
                var param = data.businessDistrictId;
                businessDistrict.click.r(param).then(res => {
                    if (res.data.success) {
                        vm.$message.success('切换');
                        vm.loading = false;
                        vm.search();
            ...
            deleteHandel(item, data) {
                ...
                var param = data.businessDistrictId;
                businessDistrict.remove.r(param).then(res => {
                    if (res.data.success) {
