    ...
    <div v-loading="loading">
        ...
        <div class="searchBox">
            <el-row v-model="queryParms" :gutter="20" class="operation">
                ...
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">状态（0:弃用，1:在用）： </span>
                    <el-input class="SearchInput" v-model="queryParms.status" placeholder="请输入状态（0:弃用，1:在用）"></el-input>
                </el-col>
                <el-col :span="8">
        ...
        <div class="resultBox">
            ...
            <el-table :data="list" border style="width: 100%">
                ...
                <el-table-column prop="isThumbImage" label="是否有缩略图" align="center"></el-table-column>
                <el-table-column prop="status" label="状态（0:弃用，1:在用）" align="center"></el-table-column>
