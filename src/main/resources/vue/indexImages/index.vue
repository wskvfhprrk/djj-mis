    ...
    <div v-loading="loading">
        ...
        <div class="searchBox">
            <el-row v-model="queryParms" :gutter="20" class="operation">
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">图片地址： </span>
                    <el-input class="SearchInput" v-model="queryParms.imageUrl" placeholder="请输入图片地址"></el-input>
                </el-col>
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">类型（0-店铺 1-代金券 2-网址 ）： </span>
                    <el-input class="SearchInput" v-model="queryParms.type" placeholder="请输入类型（0-店铺 1-代金券 2-网址 ）"></el-input>
                </el-col>
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">链接地址： </span>
                    <el-input class="SearchInput" v-model="queryParms.address" placeholder="请输入链接地址"></el-input>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                    <el-button size="medium" type="primary" v-allow="indexImages_get" @click="search">查询</el-button>
                </el-col>
            </el-row>
        </div>
        <!-- 操作 end-->
        ...
        <div class="resultBox">
            <el-row :gutter="20">
                ...
                <el-button class="addBtn" v-allow="indexImages_post" @click="add" size="medium" type="primary">新增
                </el-button>
            </el-row>
            <el-table :data="list" border style="width: 100%">
                <el-table-column prop="imageUrl" label="图片地址" align="center"></el-table-column>
                <el-table-column prop="type" label="类型（0-店铺 1-代金券 2-网址 ）" align="center"></el-table-column>
                <el-table-column prop="address" label="链接地址" align="center"></el-table-column>
                <el-table-column label="操作" width="200" align="center">
                    <template slot-scope="scope">
                        <el-button v-allow="indexImages_put" size="mini" type="info" @click="edit(scope.$index,scope.row)">
                            编辑</el-button>
                        <el-button size="mini" type="danger" v-allow="indexImages_*_delete" @click="deleteHandel(scope.$index,scope.row)">
                            删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    import * as indexImages from '../../api/indexImages.js';
    ...
    export default {
        ...
        methods: {
            ...
            fetchData(param) {//查询
                ...
                indexImages.list.r(str).then((res) => {
            ...
            getViewInfo(data) {
                ...
                indexImages.view.r(data.id).then(res => {
                    if (res.data.success) {
            ...
            submitHandle() {//新增提交
                ...
                vm.loading = true
                indexImages.add.r(vm.$refs.formPage.form).then(res => {
                    if (res.data.success) {
            ...
            editsubmit() {//新增提交
                ...
                vm.loading = true
                indexImages.edit.r(vm.$refs.formPage.form).then(res => {
                    if (res.data.success) {
            ...
            clock(item, data) {
                ...
                var param = data.id;
                indexImages.clock.r(param).then(res => {
                    if (res.data.success) {
            ...
            click(item, data) {
                ...
                var param = data.id;
                indexImages.click.r(param).then(res => {
                    if (res.data.success) {
                        vm.$message.success('切换');
                        vm.loading = false;
                        vm.search();
            ...
            deleteHandel(item, data) {
                ...
                var param = data.id;
                indexImages.remove.r(param).then(res => {
                    if (res.data.success) {
