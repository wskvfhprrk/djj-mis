    ...
    <div v-loading="loading">
        ...
        <div class="searchBox">
            <el-row v-model="queryParms" :gutter="20" class="operation">
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">空间名称： </span>
                    <el-input class="SearchInput" v-model="queryParms.name" placeholder="请输入空间名称"></el-input>
                </el-col>
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">所属店铺： </span>
                    <el-input class="SearchInput" v-model="queryParms.shopId" placeholder="请输入所属店铺"></el-input>
                </el-col>
                <el-col class="marginBottom" :span="8">
                ...
                <el-col class="marginBottom" :span="8">
                    ...
                    <el-date-picker class="SearchInput"  v-model="queryParms.startDate" type="date" placeholder="选择标签"></el-date-picker>
                </el-col>
                <el-col class="marginBottom" :span="8">
                ...
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">类型（0-公开 1-内部）： </span>
                    <el-input class="SearchInput" v-model="queryParms.type" placeholder="请输入类型（0-公开 1-内部）"></el-input>
                </el-col>
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">状态（0-新建 1-已上架 2-已下架）： </span>
        ...
        <div class="resultBox">
            ...
            <el-table :data="list" border style="width: 100%">
                ...
                <el-table-column prop="useThreshold" label="使用门槛（消费满多少元可以使用）" align="center"></el-table-column>
                <el-table-column prop="startDate" label="标签" align="center"></el-table-column>
                ...
                <el-table-column prop="type" label="类型（0-公开 1-内部）" align="center"></el-table-column>
                <el-table-column prop="status" label="状态（0-新建 1-已上架 2-已下架）" align="center"></el-table-column>
