    ...
    <div v-loading="loading">
        ...
        <div class="searchBox">
            <el-row v-model="queryParms" :gutter="20" class="operation">
                ...
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">性别（0：未知,1:男，2:女）： </span>
        ...
        <div class="resultBox">
            ...
            <el-table :data="list" border style="width: 100%">
                ...
                <el-table-column prop="sex" label="性别（0：未知,1:男，2:女）" align="center"></el-table-column>
                ...
                <el-table-column prop="shopId" label="归属店铺ID" align="center"></el-table-column>
