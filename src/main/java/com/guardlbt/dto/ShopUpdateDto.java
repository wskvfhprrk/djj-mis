...
public class ShopUpdateDto {
    ...
    @NotBlank(message = "logo图片不能为空值")    private String logoImage;

    @ApiModelProperty("图片（可以多张）") 
    @NotBlank(message = "图片（可以多张）不能为空值")    private String images;

    @ApiModelProperty("商圈") 
    @NotBlank(message = "商圈不能为空值")    private String businessDistrictId;
    ...
    @NotBlank(message = "负责人不能为空值")    private String custodian;

    @ApiModelProperty("行业") 
    @NotBlank(message = "行业不能为空值")    private String profession;
    ...
    @ApiModelProperty("状态（0-未审核 1-已发布 2-已下架）") @NotNull(message = "状态（0-未审核 1-已发布 2-已下架）不能为空值")
