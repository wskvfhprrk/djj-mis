...
public class ShopUserUpdateDto {
    ...
    @NotBlank(message = "性别（0:男，1:女）不能为空值")    private String sex;
    ...
    @NotBlank(message = "角色（0-老板 1-店长 2-员工）不能为空值")    private String role;
    ...
    @NotBlank(message = "状态（0-正常 1-暂停 2-注销）不能为空值")    private String status;
