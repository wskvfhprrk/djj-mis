...
public class MD5Util {
	...
	public static void main(String[] args) throws IOException {
 		String s="10011234505cc30a7affa4de68d8f5631b85411f74401000112345123456789412345";
 		String sign="12e2a35c1b93617823fa8116aba8576d";
		String md5String = MD5Util.getMD5String(s.trim());
